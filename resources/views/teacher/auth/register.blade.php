<x-teacher-guest-layout>
    <form method="POST" action="{{ route('teacherregister') }}">
        ...
        <div>
            ...
            <x-text-input id="collage" class="block mt-1 w-full" type="text" name="collage" :value="old('collage')" required autofocus autocomplete="collage" />
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('teacherlogin') }}">
