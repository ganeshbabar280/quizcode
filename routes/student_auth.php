...
Route::middleware('guest:student')->group(function () {
    Route::get('studentregister', [RegisteredUserController::class, 'create'])
                ->name('studentregister');

    Route::post('studentregister', [RegisteredUserController::class, 'store']);

    Route::get('studentlogin', [AuthenticatedSessionController::class, 'create'])
                ->name('studentlogin');

    Route::post('studentlogin', [AuthenticatedSessionController::class, 'store']);
...
Route::middleware('student')->group(function () {
   ...
   // Route::get('verify-email/{id}/{hash}', VerifyEmailController::class)
    ...
    Route::get('studentlogout', [AuthenticatedSessionController::class, 'destroy'])
                ->name('studentlogout');
});
